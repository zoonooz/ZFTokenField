...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of IAWCustomTokenField in Markdown format.
  ...
  # Or just: s.author    = "Unity App Studio"
  # s.authors            = { "Unity App Studio" => "admin@unityappstudio.com" }
  # s.social_media_url   = "http://twitter.com/Unity App Studio"
